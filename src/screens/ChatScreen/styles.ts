...
const createIndicatorStyles = (colors: ThemeColors) => ({
  ...
  accelTipHeaderRow: { flexDirection: 'row' as const, alignItems: 'center' as const, gap: 8 },
  accelTipText: { ...TYPOGRAPHY.meta, color: colors.textSecondary, flex: 1 },
  accelTipActionsRow: { flexDirection: 'row' as const, gap: 8 },
  accelTipButton: {
    flexDirection: 'row' as const,
    alignItems: 'center' as const,
    gap: 6,
  ...
  accelTipButtonPrimary: { borderColor: colors.primary, backgroundColor: `${colors.primary}20` },
  accelTipButtonText: { ...TYPOGRAPHY.meta, color: colors.textSecondary },
  accelTipButtonTextPrimary: { ...TYPOGRAPHY.meta, color: colors.primary },
